...
|---|---|---|---|
| 2026-09-10 | Codex, independent | [2026-09-10-independent-statistical-audit-chatgpt.md](2026-09-10-independent-statistical-audit-chatgpt.md) | Engine and documentation at ae37f0e; integer-distance trial reference, exact ranked-selection counterexamples, selection-bias experiment, unresolved coverage and API round trips; five findings awaiting adjudication |
