...
writeLines(c(R.version.string,paste('Platform:',R.version$platform),paste('Locale:',Sys.getlocale()),
  ...
  'Audited commit: a796e51d6a66b590fc09394488811f8cac2c8060',
  'Source: isolated git archive; shared checkout and dependencies unchanged.'),file.path(out,'runtime.txt'))
